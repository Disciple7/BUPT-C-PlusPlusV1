...
void wordList_init(vector<string>& wordList)
{
	...
	fstream wordFile;
	if(DEV_MODE)
		wordFile.open("D:\\coding\\C++Final\\C++Final_1\\Debug\\wordList.csv", ios::out | ios::in);
	else
...
void playerList_init(vector<player>& playerList)
{
	...
	fstream playerFile;
	if(DEV_MODE)
		playerFile.open("D:\\coding\\C++Final\\C++Final_1\\Debug\\playerList.csv", ios::out | ios::in);
	else
...
void testerList_init(vector<tester>& testerList)
{
	...
	fstream testerFile;
	if(DEV_MODE)
		testerFile.open("D:\\coding\\C++Final\\C++Final_1\\Debug\\testerList.csv", ios::out | ios::in);
	else
